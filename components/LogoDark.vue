<template>
    <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
        ...
        xmlns="http://www.w3.org/2000/svg" id="svg28" xml:space="preserve" enable-backgrounfill="inherit"
        viewBox="0 0 270 85" height="85" width="270" y="0px" x="0px" d="new 0 0 300 90.722" fill="currentColor"
        version="1.1">
        <g transform="translate(0,-5.7220006)" id="g20" class="logo_horz__lettering" fill="#fff">
        </g>
        <g transform="translate(-7.664,4.6855006)" id="g862" fill="currentColor">
            <path transform="translate(0,-5.7220006)" fill="white"
            ...
            <path transform="translate(0,-5.7220006)" fill="white"
                ...
                id="path10" />
            <path transform="translate(0,-5.7220006)" fill="white" d="m 201.286,26.786 v 31.763 h -2.343 V 26.786 Z"
                id="path12" />
            <path transform="translate(0,-5.7220006)" fill="white"
